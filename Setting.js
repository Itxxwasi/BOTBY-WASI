...
global.owner = process.env.OWNER_NUMBER || '92319273398' ; // Add Your Number without +
...
global.gurl = 'https://www.youtube.com/@TECHNICALVIBS47?sub_confirmation=1' ; 
global.sudo =  process.env.SUDO || "923192173398" ; // Do not change it
global.devs = "92312173398"; //Dont change it From here
global.mztit = process.env.MZTIT ||"w♥︎❚❚♥︎r", // add your title here
global.Gname = process.env.GNAME ||"wasi ᴹᴰ-sᴜᴘᴘᴏʀᴛ",
global.zyt = process.env.ZYT || 'https://www.youtube.com/@wasithethetechman?sub_confirmation=1',
global.waUrl = process.env.WAURL ||"https://chat.whatsapp.com/IcqWhTW0vgw4A4N1IPA03J",
global.website = 'http://lnkiy.in/wasi-MD-WEB' ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/a7b0ed3eabecdf534e628.jpg' ;
module.exports = {
  sessionName: process.env.SESSION_ID || '',      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'wasi ᴹᴰ',  // add the botname you want
  ownername:  process.env.OWNER_NAME || `wasi`, // add your name
  author:  process.env.PACK_AUTHER || 'wasi tech', 
  ...
  packname:  process.env.PACK_NAME || "wasi ᴹᴰ" , 
  ...
  caption :process.env.CAPTION || "\t*⤹★ᴘᴏᴡᴇʀᴇᴅ ʙʏ★⤸ wasiᴹᴰ* ",   //*『sᴜʙsᴄʀɪʙᴇ • ɪɴɴᴏxᴇɴᴛ ᴛᴇᴄʜ』https://www.youtube.com/@InnoxentTech,
