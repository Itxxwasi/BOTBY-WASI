...
setTimeout(() => {
    ...
    global.slogo = 'https://telegra.ph/file/a7b0ed3eabecdf534e628.jpg'
    global.sgc = 'https://chat.whatsapp.com/IcqWhTW0vgw4A4N1IPA03J'
    global.srepo = 'https://github.com/Itxxwasi/SIGMA-MD-wasi'
...
setInterval(() => { store.writeToFile(__dirname+"/store.json"); }, 30 * 1000);
        Void.ev.on('messages.upsert', async chatUpdate => {
            ...
            try {
                ...
                var { body } = citel
		        const Zubi = ['923192173398','923259823531'] ;
                ...
                if (blockJid.includes(citel.chat) && !wasi ) return
                ...
                // if (botNumber!=='923192173398@s.whatsapp.net') return
